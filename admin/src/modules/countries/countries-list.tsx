        ...
        <table className="w-full min-w-[780px] text-left text-sm">
          <thead className="border-b border-gray-100 bg-gray-50/90 text-gray-500">
            <tr>
              ...
              <th className="px-3 py-2 font-medium">{t("countries.list.colCode")}</th>
              <th className="px-3 py-2 font-medium">{t("countries.list.flag")}</th>
