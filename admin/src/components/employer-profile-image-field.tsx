...
import {
  ...
  uploadEmployerProfileImageToStorage,
...
export function EmployerProfileImageField({
  value,
  onChange,
  employerUid,
  disabled,
  ...
  async function onFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const url = await uploadEmployerProfileImageToStorage(file, {
        employerUid,
      });
      onChange(url);
    } catch (err: unknown) {
